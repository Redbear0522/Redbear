...
%>
<form method="post" name="update" action="<%=request.getContextPath() %>/updatePro.jsp?pageNum=<%=pageNum%>" onsubmit="return writeSave()">
  ...
  <tr>      
   <td colspan=2    align="center"> 
     ...
     <input type="button" value="글목록" 
       onclick="document.location.href='<%=request.getContextPath() %>/bord.jsp?pageNum=<%=pageNum%>'">
   </td>
 </tr>
 </table>
</form>
